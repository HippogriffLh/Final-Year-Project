...
def generate_launch_description():
  ...
  map_file_path = 'maps/room_3_world/room_3_world.yaml'
  nav2_params_path = 'params/room_world/nav2_params.yaml'
  robot_localization_file_path = 'config/ekf.yaml'
  rviz_config_file_path = 'rviz/room_world/nav2_config.rviz'
  sdf_model_path = 'models/two_wheeled_robot_description/model.sdf'
  urdf_file_path = 'urdf/two_wheeled_robot.urdf'
  world_file_path = 'worlds/room_3.world'
